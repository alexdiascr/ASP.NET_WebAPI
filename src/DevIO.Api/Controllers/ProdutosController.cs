...
namespace DevIO.Api.Controllers
{
    ...
    public class ProdutosController : MainController
    {
        ...
        [HttpPost("Adicionar")]
        //Limite de 30 mb para upload de imagens
        //Alternativo a base 64 
        public async Task<ActionResult<ProdutoViewModel>> AdicionarAlternativa(
        ...
        [RequestSizeLimit(40000000)]//Estabelendo um limite de 40 mb
        [HttpPost("imagem")]
        //Vai fazer um stremmig/ para fazer/mandar de forma fatiada a imagem  
        ...
        private async Task<bool> UploadArquivoAlternativo(IFormFile arquivo, string imgPrefixo)
        {
            ...
            var filePath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", imgPrefixo + arquivo.FileName);
